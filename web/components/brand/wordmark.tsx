...
// The mark is the name, set in plain capitals and widely tracked — nothing
// else. A logotype has to stay legible at 13px in a collapsed sidebar, so it
// carries no ornament, just the name set apart by spacing.
//
