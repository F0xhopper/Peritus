 ...
 *
 * Inlined as SVG with the brand's own hex values: it is the one place in the
 * product that uses colours from outside the palette, because Google's
 * identity guidelines require the mark unaltered and a recoloured "G" is both
 * a licensing problem and a less recognisable button.
 */
