"""Use case: generate a structured course from a Peritus Expert."""
...
async def generate_course_stream(
    ...
    """
    Stream a structured Markdown course generated by the expert.

    Args:
        expert: The Peritus Expert entity.
        difficulty: Course difficulty level.
        focus: Optional custom focus area.

    Yields:
        Markdown text chunks (SSE-compatible).

    Raises:
        ExpertNotFoundError: If expert is not ready.
        CourseGenerationError: On generation failure.
    """
